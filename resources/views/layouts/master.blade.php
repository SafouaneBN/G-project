                    ...
                    @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 3)
                        <li class="collapsed">
                            <a class="m-link @yield('client')" data-bs-toggle="collapse"
                                ...
                                <i class="icofont-user-male"></i> <span>Client</span> <span
                    ...
                    @if (Auth::user()->role_id == 3)
                        <li class="collapsed">
                            <a class="m-link @yield('parametre') @yield('statut')" data-bs-toggle="collapse"
                                ...
                                <i class="icofont-ui-settings"></i> <span>Parametre</span> <span
                                    class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                            <!-- Menu: Sub menu ul -->
                            <ul class="sub-menu collapse" id="app-Components">
                                <li><a class="ms-link @yield('parametre')" href="{{ route('parametre.role') }}">
                                        <span>Role</span></a></li>
                                <li><a class="ms-link @yield('statut')"
                                        href="{{ route('parametre.statut') }}"><span>Categorie statut</span></a></li>
                                <li><a class="ms-link @yield('cat_tache')"
                                        href="{{ route('parametre.cat_tache') }}"><span>Categorie tache</span></a></li>
                                <li><a class="ms-link @yield('cat_livrable')"
                                        href="{{ route('parametre.cat_livrable') }}"><span>Categorie
                                            livrable</span></a></li>
                            </ul>
                        </li>
                    @endif
                            ...
                            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                                <div class="d-flex">
                                    ...
                                    <div class="avatar-list avatar-list-stacked px-3">
                                        ...
                                        <img class="avatar rounded-circle"
                                            src="{{ asset('assets/images/xs/avatar8.jpg') }}" alt="">
                                                        ...
                                                        @forelse ($notifications as $notification)
                                                            @if ($notification->etat == 'not readed')
                                                                <li class="py-2 mb-1 border-bottom"
                                                                    style="background-color:#F7F4F9; padding: 1rem 1rem;">
                                                                    <a href="{{ route('readnotify', $notification->id) }}"
                                                                        class="d-flex">
                                                                        <img class="avatar rounded-circle"
                                                                        ...
                                                                        <div class="flex-fill ms-2">
                                                                            <p
                                                                                ...
                                                                                <span
                                                                                    class="font-weight-bold">{{ $notification->user_notification->name }}</span>
                                                                                <small>{{ date('M d,Y', strtotime($notification->created_at)) }}</small>
                                                                            </p>
                                                                            <span class="">Nouveau activite
                                                            ...
                                                            @else
                                                                <li class="py-2 mb-1 border-bottom"
                                                                    style="background-color:white; padding: 1rem 1rem;">
                                                                    <span class="d-flex">
                                                                        <img class="avatar rounded-circle"
                                                                            src="{{ asset('assets/images/xs/avatar1.jpg') }}"
                                                                            alt="">
                                ...
                                <div
                                    ...
                                    <div class="u-info me-2">
                                        ...
                                        <small>{{ Auth::user()->user_role->libelle }} Profile</small>
                                    </div>
                                        ...
                                        <div class="card border-0 w280">
                                            <div class="card-body pb-0">
                                                <div class="d-flex py-1">
                                                    <img class="avatar rounded-circle"
                                                        src="{{ asset('assets/images/profile_av.png') }}"
                                                        alt="profile">
                            ...
                            <div class="order-0 col-lg-4 col-md-4 col-sm-12 col-12 mb-3 mb-md-0 ">
                                <div class="input-group flex-nowrap input-group-lg">
                                    ...
                                    <button type="button" class="input-group-text add-member-top"
                                        id="addon-wrappingone" data-bs-toggle="modal" data-bs-target="#addUser"><i
