                                ...
                                <td class=" dt-body-right">
                                    <div class="btn-group" Statut="group" aria-label="Basic outlined example">
                                        <button type="button" class="btn btn-outline-secondary editbtn"
                                            value="{{ $opportunite->id }}" data-bs-toggle="modal"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm">
                                    ...
                                    <label for="exampleFormControlInput977" class="form-label">Opportunite</label>
                                    <input type="text" class="form-control" id="Opportunite_edit"
                                        name="Opportunite_edit" id="exampleFormControlInput977" placeholder="">
                                </div>
                            </div>
