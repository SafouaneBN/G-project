                                ...
                                <div class="flex-grow-1 mem-list">
                                    <div class="py-2 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex ms-2 align-items-center flex-fill">
                                            <img src="{{ asset('assets/images/xs/avatar6.jpg') }}" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
                                    ...
                                    <div class="py-2 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex ms-2 align-items-center flex-fill">
                                            <img src="{{ asset('assets/images/xs/avatar4.jpg') }}" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
                                            <div class="d-flex flex-column ps-2">
                                    ...
                                    <div class="py-2 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex ms-2 align-items-center flex-fill">
                                            <img src="{{ asset('assets/images/xs/avatar9.jpg') }}" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
                                            <div class="d-flex flex-column ps-2">
                                    ...
                                    <div class="py-2 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex ms-2 align-items-center flex-fill">
                                            <img src="{{ asset('assets/images/xs/avatar10.jpg') }}" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
                                            <div class="d-flex flex-column ps-2">
                                    ...
                                    <div class="py-2 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex ms-2 align-items-center flex-fill">
                                            <img src="{{ asset('assets/images/xs/avatar11.jpg') }}" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
                                            <div class="d-flex flex-column ps-2">
                                    ...
                                    <div class="py-2 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex ms-2 align-items-center flex-fill">
                                            <img src="{{ asset('assets/images/xs/avatar3.jpg') }}" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
                                            <div class="d-flex flex-column ps-2">
                                            ...
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar2.jpg') }}" alt="">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar1.jpg') }}" alt="">
                                                    </div>
                                    ...
                                    <li class="dd-item" data-id="2">
                                        <div class="dd-handle">
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar7.jpg') }}" alt="">
                                                    </div>
                                    ...
                                    <li class="dd-item" data-id="4">
                                        <div class="dd-handle">
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar6.jpg') }}" alt="">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar5.jpg') }}" alt="">
                                                    </div>
                                                    <span class="badge bg-warning text-end mt-2">MEDIUM</span>
                                                </div>
                                            </div>
                                    ...
                                    <li class="dd-item" data-id="2">
                                        <div class="dd-handle">
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar8.jpg') }}" alt="">
                                                    </div>
                                                    <span class="badge bg-success text-end mt-2">LOW</span>
                                                </div>
                                            </div>
                                    ...
                                    <li class="dd-item" data-id="3">
                                        <div class="dd-handle">
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar3.jpg') }}" alt="">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar1.jpg') }}" alt="">
                                                    </div>
                                                    <span class="badge bg-warning text-end mt-2">MEDIUM</span>
                                                </div>
                                    ...
                                    <li class="dd-item" data-id="5">
                                        <div class="dd-handle">
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar4.jpg') }}" alt="">
                                                    </div>
                                    ...
                                    <li class="dd-item" data-id="4">
                                        <div class="dd-handle">
                                            <div class="task-info d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                    <div class="avatar-list avatar-list-stacked m-0">
                                                        <img class="avatar rounded-circle small-avt" src="{{ asset('assets/images/xs/avatar11.jpg') }}" alt="">
                                                    </div>
                                                    <span class="badge bg-danger text-end mt-2">High</span>
                                                </div>
                                            </div>
