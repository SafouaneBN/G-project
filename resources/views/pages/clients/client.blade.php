                                        ...
                                        <div
                                            ...
                                            <div class="btn-group mt-2" role="group" aria-label="Basic outlined example">
                                                <button type="button" class="btn btn-outline-secondary editbtn"
                                                    value="{{ $client->id }}" data-bs-toggle="modal"
                                                    data-bs-target="#editproject"><i
                                                        class="icofont-edit text-success"></i></button>
                                                <button type="button" attr_id="{{ $client->id }}" class="Bdelete_btn"
                ...
                <form method="post" action="{{ route('parametre.addClient') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <div class="col-sm">
                                ...
                                <input type="text" class="form-control" name="full_name"
                                    id="exampleFormControlInput877" placeholder="">
                            </div>
                            <div class="col-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="telephone" id="exampleFormControlInput977"
                                placeholder="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <div class="col-sm">
                                ...
                                <input type="text" class="form-control" name="full_name_edit" id="full_name_edit"
                                    placeholder="">
                            </div>
                            <div class="col-sm">
                                <label for="exampleFormControlInput977" class="form-label">email</label>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-sm">
                                <label for="exampleFormControlInput977" class="form-label">ville</label>
                                <input type="text" class="form-control" name="ville_edit" id="ville_edit"
                                    placeholder="">
                            </div>
                            <div class="col-sm">
                                <label for="exampleFormControlInput977" class="form-label">pays</label>
                                <input type="text" class="form-control" name="pays_edit" id="pays_edit"
                                    placeholder="">
                            </div>
