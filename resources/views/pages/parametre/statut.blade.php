                ...
                <div class="col-sm-12">
                        ...
                        <div class="border-0 mb-4">
                            <div
                                ...
                                <div class="col-auto d-flex w-sm-100">
                                    <button type="button" class="btn btn-dark btn-set-task w-sm-100 mr-10" style="margin-right: 7px;" data-bs-toggle="modal"
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <table id="myProjectTable2" class="table table-hover align-middle mb-0 patient-table" style="width: 100%;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @forelse ($statuts as $statu)
                                        <tr role="row "class="Rowdelete2{{ $statu->id }} odd">
                                            <td class="statut">{{ $statu->statut }}</td>

                                            <td class="">{{ $statu->catStatu_statut->libelle }}</td>
                                            <input type="hidden" class="cat_statu"value="{{ $statu->statut_id }}">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('parametre.update') }}" class="forms-sample" method="post">
                    ...
                    <div class="modal-body">
                        <div class="deadline-form">
                            <div class=" mb-3">
                                <input type="hidden" id="id_statuts" name="id" value="">
...
@section('scripts')
    <script>
        ...
        $("#myProjectTable2").on("click", ".edit_statut2", function() {
            ...
            $("#c_statut").val($(this).parent().parent().parent().find(".cat_statu").val());
