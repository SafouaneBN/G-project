                        ...
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <div class="col-auto d-flex w-sm-100">
                                    <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#depadd"><i class="icofont-plus-circle me-2 fs-6"></i>Ajouter Categorie statut</button>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                    ...
                                    <tr class="Rowdelete{{ $statut->id }}">
                                        ...
                                        <td>
                                            <div class="btn-group" Statut="group" aria-label="Basic outlined example">
                                                <button class="edit_statut" value="{{$statut->id}}" style="border: none" type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#depedit"><i class="icofont-edit text-success"></i></button>
                                                <button type="button"  attr_id ="{{ $statut->id }}"class ="Bdelete_btn" style="border: none" class="sup_statut" class="btn btn-outline-secondary deleterow"><i class="icofont-ui-delete text-danger"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <div class="col-auto d-flex w-sm-100">
                                    <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#depadd2"><i class="icofont-plus-circle me-2 fs-6"></i>Ajouter Statut</button>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                ...
                                <tbody>
                                    <tr class="Rowdelete2{{ $statu->id }}">
                                       ...
                                       <td class="cat_statu">{{ $statu->catStatu_statut->libelle }}</td>
                                        ...
                                        <td>
                                            <div class="btn-group" Statut="group" aria-label="Basic outlined example">
                                                <button class="edit_statut2" value="{{$statu->id}}" style="border: none" type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#depedit2"><i class="icofont-edit text-success"></i></button>
                                                <button type="button"  attr_id2 ="{{ $statu->id }}"class ="Bdelete_btn2" style="border: none" class="sup_statut" class="btn btn-outline-secondary deleterow"><i class="icofont-ui-delete text-danger"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
                            ...
                            <div class="modal-body">
                                <div class="deadline-form">
                                    ...
                                    <div class=" mb-3">
                                            ...
                                            <label for="Libelle" class="form-label">Categorie Statut</label>
                                            <select class="form-select" name="c_statut" id=c_statut aria-label="Default select Priority">
                                                @forelse ($cat_statuts as $statut)
                                                    <option value="{{ $statut->id }}">{{ $statut->libelle }}</option>
                                                @empty
                                                    <option selected="">ajouter category statuts</option>
