                            ...
                            <form method="POST" action="{{ route('login') }}" class="row g-1 p-3 p-md-4">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="password" id="password" class="form-control form-control-lg @error('password') is-invalid @enderror" placeholder="***************" name="password" required autocomplete="current-password">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
